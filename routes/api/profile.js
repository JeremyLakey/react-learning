...
router.get('/user/:id', async (req, res) => {
    try {
        ...
        if(!profile) {
            return res.status(400).send('Pofile not found');
        }
        res.json(profile);
...
// @desc    create/update user profile from jwt
// @access  Private
...
// @desc    Delete from profile by experience id
// @access  Private
...
// @desc    Delete from profile by education id
// @access  Private
